...
#define WIFI_SSID "Hathway_Anuradha 3"             //Enter Wifi Name
#define WIFI_PASS "6300339243"         //Enter wifi Password
...
{  
  ...
  if (RelayPin1 == 16 && toggleState_1 == 1 ){
    Serial.print("recived the data fro blynk ");
  ...
  if (RelayPin2 == 5 && toggleState_2 == 0 ){
    toggleState_1 == 0;
    Serial.print("emergency vechicle arived");
     digitalWrite(RelayPin1, 1);
     digitalWrite(RelayPin2, 1);
     digitalWrite(RelayPin3, 0);
     ...
     digitalWrite(RelayPin3, 1);
     digitalWrite(RelayPin4, 0);
     Serial.print("emergency vechicle left");
     toggleState_2 =1;
     toggleState_1 = 1;
